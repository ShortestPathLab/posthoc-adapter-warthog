...
public:
  ...
  virtual void get_path(warthog::problem_instance &pi, warthog::solution &sol) {
  ...
  virtual void get_pathcost(warthog::problem_instance &pi,
  ...
  void set_max_k_moves(uint32_t k_moves) { max_k_moves_ = k_moves; }

  uint32_t get_max_k_moves() { return max_k_moves_; }

  virtual size_t mem() { return sizeof(*this); }
